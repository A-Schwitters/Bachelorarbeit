...
\newcommand{\versuchstitel}{Optimierung des Erwärmungsprüfstandes zum Nachweis von Bemessungsbetriebsströmen in Feldern mit mehreren, gleichzeitig belasteten Abgangseinheiten.}
\newcommand{\fachbereich}{Ingenieurswissenschaften}
\newcommand{\studiengang}{Studiengang Elektrotechnik}
\newcommand{\vornameStudEins}{Alexander}
\newcommand{\nachnameStudEins}{Schwitters}
\newcommand{\matrikelnummerStudEins}{6045696}
\newcommand{\vornameStudZwei}{}
\newcommand{\nachnameStudZwei}{}
\newcommand{\matrikelnummerStudZwei}{}
\newcommand{\autorenname}{\vornameStudEins~\nachnameStudEins}
\newcommand{\betreuerEins}{Prof. Dr.~X~Y}
\newcommand{\betreuerZwei}{Dipl.-Ing.~/B.~Eng.~X~Y}
\newcommand{\betreuerDrei}{Dipl.-Ing.~Holger~Kuhlemann}
\newcommand{\betreuerVier}{B.~Eng.~Simon~Westerbur,}
