...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.30\textwidth]{03_Ressourcen/pic/MCC_Feld_1.png}
    \caption{Frontansicht des MCC-Feldes bestückt mit Einschubmodulen}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.30\textwidth]{03_Ressourcen/pic/MCC_Kupfer.png}
     \caption{Vertikales Verteilschienensystem}
    \label{fig:sub_mcc_kupfer}
\end{figure}
